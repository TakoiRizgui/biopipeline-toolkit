...
**Takoi Rizgui**
- 🎓 Mastère Bioinformatique (Projet Tuniso-Italien, 2026)
- 🎓 M2 Big Data, Data Science & IA (2024-2025)
- 🔬 Ex-Technicienne Laboratoire Médical (5 ans)
- 🌍 Tunis, Tunisie

**Parcours :** Reconversion de la biologie médicale vers la data science et la bioinformatique.
...
*Combining medical expertise with artificial intelligence for safer, more efficient biotechnology*
